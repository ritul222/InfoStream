...
const formattedYesterday = yesterday.toISOString().slice(0, 10);
  ...
  const fetchNews = async () => {
    try {
      ...
      const response = await axios.get(`https://newsapi.org/v2/everything?q=Entertainment&from=${formattedYesterday}&sortBy=publishedAt&apiKey=${newsApiKey}&language=en`);
